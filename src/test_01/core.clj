...
(def student-tbl (read-file (io/resource "student.csv")))

(def subject-tbl (read-file (io/resource "subject.csv")))

(def student-subject-tbl (read-file (io/resource "student_subject.csv")))
